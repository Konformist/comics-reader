...
class ParserConfigDaoTest {
  private lateinit var db: AppDatabase
  private lateinit var dao: ParserConfigDao
  ...
  fun testCreateNullable() {
    ...
    Assert.assertEquals("", row?.siteUrl)
  ...
  @Test
  fun testDelete() {
    val create = ParserConfigCreate(name = "New row")
    val rowId = dao.create(create)
    val delete = ParserConfigDelete(id = rowId)
    dao.delete(delete)
    val row = dao.read(rowId)
