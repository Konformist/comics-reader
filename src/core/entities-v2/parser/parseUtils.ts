import type ComicOverrideModel from '@/core/entities-v2/comic-override/ComicOverrideModel.ts';
import type ParserModel from '@/core/entities-v2/parser/ParserModel.ts';
import type { IParsedComic } from '@/core/entities-v2/parser/ParserTypes.ts';
